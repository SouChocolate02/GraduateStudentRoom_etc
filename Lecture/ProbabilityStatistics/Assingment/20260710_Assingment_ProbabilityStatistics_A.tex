...
\end{document}
	...
	\item[$\Rightarrow$] 
	$\exists x\in S$と$x$に収束する点列$\{x_n\}$ととる．また$\alpha$を$0< \alpha< I(x)$をみたすようにとる．下半連続の定義より集合$U_\alpha= \{y\in S; I(y)> \alpha\}$は開集合である．$I(x)> \alpha$であったから$x\in U_\alpha$．\\
	$U_\alpha$は$x$の開近傍であり，$x_n\to x$であるから$n\ge N$で$I(x_n)\to x$が成り立つ．下極限をとると，$\liminf_{x\to \infty} I(x_n)= \alpha$
